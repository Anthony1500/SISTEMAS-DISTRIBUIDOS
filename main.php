        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    ...
                    <a href="main.php?pag=updatefacultad">
                        <i class="metismenu-icon pe-7s-display2"></i>
                        Editar Facultad
                    </a>
                ...
                <li>
                    <a href="main.php?pag=reportecarrera">
                        <i class="metismenu-icon pe-7s-display2"></i>
                        Reporte Carrera
                    </a>
                    <a href="main.php?pag=reporteconsultor">
                        <i class="metismenu-icon pe-7s-display2"></i>
                        Reporte Consultor
                    </a>
                    <a href="main.php">
                    ...
                    <a href="main.php?pag=reporteproyecto">
                        <i class="metismenu-icon pe-7s-display2"></i>
                        Reporte Proyecto
                    </a>
                    <a href="main.php?pag=reporteseguimiento">
                        <i class="metismenu-icon pe-7s-display2"></i>
                        Reporte Seguimiento
                    </a>
                    <a>
